...
const GameConfig = {
    levels: [
        { 
            size: 4, 
            time: 120, 
            image: 'https://img2.baidu.com/it/u=217149289,1584208225&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500' 
        },
        { 
            size: 6, 
            time: 120, 
            image: 'https://img0.baidu.com/it/u=2289324672,3399395267&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500' 
        },
        { 
            size: 8, 
            time: 120, 
            image: 'https://img1.baidu.com/it/u=3997495310,1221085061&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500' 
        }
    ],
    maxHints: 3
};
